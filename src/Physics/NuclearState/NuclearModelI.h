...
public:
  ...
  inline double         FermiMomentum   (void)           const
  {
  ...
  inline double         COMMomentum        (void)           const
  {
    return fCOMCurrMomentum.Mag();
  }
  ...
  inline const TVector3& Momentum3      (void)           const
  {
   ...
   const TVector3& COMMomentum3      (void)           const
  {
    return fCOMCurrMomentum;
  }
  ...
  inline void SetCOMMomentum3(const TVector3 & COMmom) const
  {
    fCOMCurrMomentum = COMmom;
  };
  ...
  inline void SetRecoilPDG(int pdg) const
  {
    fRecoilPDG = pdg;
  }
...
protected:
 ...
 // const genie::FermiMomentumTable & FermiMomentumTable() const { return *fKFTable ; }
  ...
  mutable TVector3 fCOMCurrMomentum;
