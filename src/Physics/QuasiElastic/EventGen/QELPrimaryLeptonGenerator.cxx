...
// This method generates the final state primary lepton in QEL events
  ...
  std::cout << "Probe P4 before Boost to COM frame: (" << p4v->X() << ", " << p4v->Y() << ", " << p4v->Z() << ", " << p4v->E() << ")" << std::endl; 

  p4v->Boost(-beta);  

  std::cout << "Probe P4 after Boost to COM frame: (" << p4v->X() << ", " << p4v->Y() << ", " << p4v->Z() << ", " << p4v->E() << ")" << std::endl; 
